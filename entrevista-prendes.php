...
<body class="entrevista entrevista-alperi">
 ...
 <?php include('includes/top-nav-entrevistas.php'); ?>

 <div class="box container" >
  <header>
    <hgroup>
      <div class="minititulo">Entrevista a José Ignacio Prendes, diputado en la Junta General del Principado</div>
     <h2>&ldquo;La gestión de los fondos mineros es el gran fracaso de la clase política asturiana&rdquo;</h2>
...
<blockquote>“Hasta 2001, Villa estuvo cobrando de forma irregular las dietas de Hunosa con un cheque nominativo”</blockquote>
 ...
 <p>—Son de esos grandes proyectos que no se hicieron con una visión estratégica de todo el territorio de Asturias y de tener rentabilidad. Por lo tanto, ha sido un fracaso. Y luego hay una cuestión: no se ha evaluado nada, no hay ningún informe serio de evaluación de rendimiento. De qué ha pasado con esos fondos, cómo se han empleado… Con esto me llevó la contraria el expresidente Areces. A mí me llevó la contraria el expresidente Areces, me dijo: &ldquo;¿Cómo que no? Se hizo una mesa específica y una evaluación&rdquo;. Esa evaluación es un folio y medio.</p>

 <blockquote>“La única evaluación del primer plan del carbón es un folio y medio”</blockquote>

 <p class="pregunta">—Sobre 3.000 millones de euros.</p>

 <p>—Sí. Y es de los mismos que gestionaron los fondos y se dan besos y abrazos y se dicen: &ldquo;qué bien lo hemos hecho. Hay que cambiar alguna cosa de gestión, agilizar más la gestión de los convenios y tal, pero está muy bien&rdquo;. A mí el tema del complejo residencial de mayores de la minería me importa especialmente. Porque yo no puedo decir de dónde salió ese dinero, porque no tengo datos suficientes, pero hay indicios claros. Nosotros pusimos el informe de la comisión parlamentaria en mano de las instituciones: este dictamen está enviado al Tribunal de Cuentas, donde hay un procedimiento abierto, y está enviado a la fiscalía del Tribunal Superior de Justicia. Ellos tienen la capacidad para desentrañar esto, que es es un auténtico escándalo. Estamos hablando de 30 millones de euros, que se dice pronto.</p>

 <blockquote>“En el geriátrico del Montepío hubo una utilización privada de fondos públicos”</blockquote>

 <p>El Montepío de la Minería es una entidad de la que hay que alabar su trayectoria, ofreciendo becas y complementos de pensiones para las viudas y los huérfanos cuando eran muy bajas. Pero a mí me parece que en esa operación [la del geriátrico del Montepío] hubo utilización de fondos públicos. Se autoconcedieron 30 millones de euros para una entidad privada que ellos mismos manejaban, haciendo un complejo residencial de lujo que no aporta beneficio social ni aporta nada. Ha sido un fiasco económico y una ruina. Finalmente acaba de concertar plazas con el Principado, aprovechando el cambio de gobierno y que no había demasiado control: se han concertado plazas cuando en el mismo concejo hay una residencia pública que no tiene fondos para abrirse completamente. Ahí hay una utilización privada de fondos públicos. Nosotros ahí [en el informe] explicamos cómo fue la adjudicación, quién fue el constructor, cómo se hizo… y sacamos hasta los balances de la empresa para que se vea dónde están los beneficios, dónde están los millones. A partir de ahí se pueden sacar conclusiones.</p>

 <p class="pregunta">—Según recoge el diario de sesiones de una de las reuniones de la Comisión Parlamentaria, Vicente Álvarez Areces decía que lo que había hecho el Principado con los fondos respondía a la lealtad institucional, que había estado un poco al margen. Y sin embargo parece que no es así, que ha jugado un papel importante. ¿Cuál es la responsabilidad, entonces, del gobierno del Principado?</p>

 <blockquote>“Los fondos mineros, que tenían que ser adicionales, acabaron casi integrándose en el presupuesto de Asturias de forma ordinaria”</blockquote>

 <p>—El Principado tiene una responsabilidad importante. El Principado era el responsable de la política económica y de la estrategia de desarrollo de Asturias, y se entregó de forma absoluta a esa estrategia equivocada. Esos fondos mineros tenían que ser unos fondos adicionales y acabaron casi integrándose en el presupuesto de Asturias de forma ordinaria. El gobierno no tenía control sobre ellos, es verdad, porque el control formaba parte de unas mesas de la minería en donde estaban, con un papel muy importante y determinante, los sindicatos. Y ha habido ese conflicto polisindical, ha habido choques, pero se aceptó ese modelo por parte del gobierno de Asturias y durante mucho tiempo estuvieron muy contentos inaugurando obras de los fondos mineros y museos que no han abierto, como la Casa del Urogallo en no sé dónde. El rosario de obras absolutamente desaprovechadas y superfluas y los millones que están tirados por ahí en infraestructuras que no sirven para nada: todo eso, con la complicidad y la colaboración del gobierno asturiano.</p>
